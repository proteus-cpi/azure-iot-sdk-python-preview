...
class ClientSharedTests(object):
    ...
    def test_connect_calls_transport(self, client, pipeline_adapter):
        client.connect()
        assert pipeline_adapter.connect.call_count == 1

    def test_disconnect_calls_transport(self, client, pipeline_adapter):
        client.disconnect()
        assert pipeline_adapter.disconnect.call_count == 1

    def test_send_event_calls_transport(self, client, pipeline_adapter):
    ...
    def test_send_event_calls_transport_wraps_data_in_message(self, client, pipeline_adapter):
    ...
    def test_send_method_response_calls_transport(self, client, pipeline_adapter):
...
class TestIoTHubModuleClient(ClientSharedTests):
    ...
    def test_send_to_output_calls_transport(self, client, pipeline_adapter):
        message = Message("this is a message")
    ...
    def test_send_to_output_calls_transport_wraps_data_in_message(self, client, pipeline_adapter):
        naked_string = "this is a message"
        output_name = "some_output"
