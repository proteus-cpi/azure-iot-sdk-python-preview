...
import abc
import logging
from azure.iot.device.iothub.pipeline.pipeline_adapter import PipelineAdapter
...
class AbstractIoTHubClient(object):
    ...
    def from_authentication_provider(cls, authentication_provider, transport_name):
        """Creates a client with the specified authentication provider and pipeline_adapter.
