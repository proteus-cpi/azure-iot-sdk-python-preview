...
from .abstract_clients import AbstractClient, AbstractIoTHubDeviceClient, AbstractIoTHubModuleClient
...
class IoTHubDeviceClient(GenericClient, AbstractIoTHubDeviceClient):
...
class IoTHubModuleClient(GenericClient, AbstractIoTHubModuleClient):
