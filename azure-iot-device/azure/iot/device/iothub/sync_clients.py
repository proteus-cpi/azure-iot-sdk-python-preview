...
class GenericIoTHubClient(AbstractIoTHubClient):
    ...
    def patch_twin_reported_properties(self, reported_properties_patch):
        ...
        """
        # OPEN QUESTION: We need to figure out our exception story.  What can this raise?
        # OPEN QUESTION: can desired and reported really be _anything_ that's JSON compatible, or can they only be dictionaries?
        pass

    def receive_desired_properties_patch(self, block=True, timeout=None):
        """
        ...
        """
        # OPEN QUESTION: exceptions again.  InboxEmpty needs to be replaced with something more appropriate
        # OPEN QUESTION: patch type again,  dict or any JSON compatible value?
        pass
