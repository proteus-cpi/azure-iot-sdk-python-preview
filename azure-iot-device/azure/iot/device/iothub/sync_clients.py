...
class GenericIoTHubClient(AbstractIoTHubClient):
    ...
    def __init__(self, pipeline_adapter):
        ...
        """
        super(GenericIoTHubClient, self).__init__(pipeline_adapter)
    ...
    def connect(self):
        ...
        self._pipeline_adapter.connect(callback=callback)
    ...
    def disconnect(self):
        ...
        self._pipeline_adapter.disconnect(callback=callback)
    ...
    def send_event(self, message):
        ...
        self._pipeline_adapter.send_event(message, callback=callback)
        send_complete.wait()
    ...
    def send_method_response(self, method_response):
        ...
        self._pipeline_adapter.send_method_response(method_response, callback=callback)
        send_complete.wait()
    ...
    def _enable_feature(self, feature_name):
        ...
        self._pipeline_adapter.enable_feature(feature_name, callback=callback)
...
class IoTHubDeviceClient(GenericIoTHubClient, AbstractIoTHubDeviceClient):
    ...
    def __init__(self, pipeline_adapter):
        ...
        :param pipeline_adapter: The pipeline_adapter that the client will use.
        """
        super(IoTHubDeviceClient, self).__init__(pipeline_adapter)
...
class IoTHubModuleClient(GenericIoTHubClient, AbstractIoTHubModuleClient):
    ...
    def __init__(self, pipeline_adapter):
        ...
        :param pipeline_adapter: The pipeline_adapter that the client will use.
        """
        super(IoTHubModuleClient, self).__init__(pipeline_adapter)
    ...
    def send_to_output(self, message, output_name):
        ...
        self._pipeline_adapter.send_output_event(message, callback)
        send_complete.wait()
