...
class IotResponseEvent(PipelineEvent):
    """
    A PipelineEvent object which is the second part of an IotRequestAndResponse operation
    (the response).  The IotRequestAndResponse represents the common operation of sending
    ...
    stage which takes the contents of this event and puts it into the IotRequestAndResponse
